import { Mail, MessageCircle, Linkedin, Github, ArrowUpRight, FileText } from 'lucide-react';
...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'adnansajjad360@gmail.com',
    href: 'mailto:adnansajjad360@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 62643 68602',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/916264368602',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/adnan-sajjad30',
    href: 'https://www.linkedin.com/in/adnan-sajjad30/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@adnan-sajjad',
    href: 'https://github.com/adnan-sajjad',
  },
];
      ...
      <FadeIn delay={0.5} y={20}>
        <div className="mx-auto mt-12 flex max-w-5xl justify-center">
          <a
            ...
            className="group inline-flex items-center gap-3 rounded-full border-2 border-[#D7E2EA]/30 bg-[#141418] px-10 py-4 text-sm font-medium uppercase tracking-widest text-[#D7E2EA] transition-all duration-300 hover:border-[#D7E2EA]/60 hover:bg-[#1a1a20] hover:-translate-y-0.5"
          >
            <FileText size={18} strokeWidth={1.5} className="transition-transform duration-300 group-hover:scale-110" />
            Download Resume
            <ArrowUpRight
              size={16}
              strokeWidth={1.5}
