...
const ABOUT_TEXT =
  "I'm a Data Analyst with 2 years of experience turning complex data into meaningful business insights. Through SQL, Power BI, Python, and Generative AI, I build dashboards, analyze trends, and deliver analytics solutions that help organizations make smarter decisions and drive growth.";
  ...
  return (
    ...
    >
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
          className="pointer-events-none absolute top-[4%] right-[1%] sm:right-[2%] md:right-[2%] w-[60px] sm:w-[160px] md:w-[210px]"
      >
        <img
          src="/ml.png"
          alt=""
      ...
      <FadeIn
        ...
        style={{ outline: '2px solid rgba(182,0,168,0.55)', outlineOffset: '3px' }}
      >
        <img
          src="/tbb.png"
          alt=""
                    ...
                    <FadeIn delay={0.15} className="w-full max-w-3xl">
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          {
                            label: 'Languages',
                            items: ['Python', 'SQL', 'DAX','Power Query'],
                          },
                          {
                            label: 'DATA ANALYTICS , BI & Libraries',
                            items: ['Power BI','Data Visualization','Dashboard Design','Business Intelligence','Financial Analytics','Pandas', 'NumPy', 'Scikit-learn', 'Pycharm','Etc'],
                          },
                          {
                            label: 'Tools & Platforms',
                            items: ['Git', 'GitHub', 'Jupyter Notebook', 'MySQL','PostgreSQL', 'Power BI', 'Power BI Service', 'Power BI Service','Excel'],
                          },
                          {
                            label: 'AI & GenAI',
                            items: ['Claude', 'OpenAI', 'Gemini',  'Prompt engineering','GenAI Integration'],
                          },
                          {
                            label: 'Data Skills',
                            items: [ 'Data Cleaning', 'EDA', 'Financial Analytics','KPI Reporting','ETL','Statistical Analysis'],
                          },
                        ].map((group) => (
                          <div
                            key={group.label}
