...
const PROJECTS: ProjectData[] = [
    {
        ...
        category: 'Personal',
        name: 'Netflix',
        liveUrl: 'https://www.kaggle.com/code/adnansajjad/netflix-eda',
        col1Image1: '/net1.png',
        col1Image2: '/net2.png',
        col2Image: '/net3.png',
      },
  {
      ...
      liveUrl: 'https://github.com/adnan-sajjad/E_Commerce_Sales_Analysis/tree/main',
      col1Image1: '/set1.png',
      col1Image2: '/set2.png',
      col2Image: '/set3.png',
    },
  {
    ...
    name: 'Music Festival',
    liveUrl: 'https://github.com/adnan-sajjad/Music_Festival/tree/main',
    col1Image1: '/let1.png',
    col1Image2: '/let2.png',
    col2Image: '/let3.png',
  },
